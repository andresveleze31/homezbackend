...
public class SolicitudService {
    ...
    public List<SolicitudDTO> getAllSolicitudesByArrendatario(Integer id) {
        List<Solicitud> solicituds = (List<Solicitud>) solicitudRepository.findBySolByArrendatarioId(id);
